                ...
                <div class="row">
                    <div class="col-12">
                        <div class="page-title-box">
                            <h4 class="page-title">Thêm Slider</h4>
                                            ...
                                            <form class="form-horizontal" action="{{ route('slider.store') }}" method="POST" enctype="multipart/form-data">
                                               @csrf
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                        <input type="number" name="sort_by" required min="1" value="1" class="form-control"
                                                            placeholder="Giá Gốc...">
                                                    </div>
                                                </div>
                                                @error('sort_by')
                                                    ...
                                                    <div class="col-lg-10">
                                                        <div class="controls">
                                                            <div class="radio radio-success">
                                                                <input type="radio" name="radio" id="radio5" value="1" checked="">
                                                                <label for="radio5">
                                                                    Có
                                                                </label>
                                                            </div>
                                                            ...
                                                            <div class="radio radio-danger">
                                                                <input type="radio" name="radio" id="radio4" value="0">
                                                                <label for="radio4">
                                                                    Không Hiển Thị
                                                                </label>
                                                            </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-lg-10">
                                                         <input type="file" required class="form-control-file" name="thumb"  >
                                                    </div>
